    ...
    return (
      <div className="max-w-lg mx-auto min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">예약 정보�?불러오는 �?..</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="max-w-lg mx-auto min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-semibold">{error || '예약 정보�?찾을 �?없습니다'}</p>
  ...
  return (
    <div className="max-w-lg mx-auto min-h-screen bg-gray-50 pb-8">
      ...
      <div className="bg-gradient-to-b from-blue-600 to-blue-500 text-white px-4 pt-12 pb-8 text-center">
        ...
        <h1 className="text-2xl font-bold mb-1">예약�?완료됐어�?</h1>
        ...
        {isBankTransfer && (
          <div className="card border-yellow-200 bg-yellow-50">
            ...
            <div className="text-sm text-yellow-800 space-y-1">
              <p>
                아래 계좌�?<strong>{formatPrice(booking.total_amount)}</strong>�?입금�?주세�?
              </p>
              <div className="mt-2 bg-yellow-100 rounded-xl px-4 py-3">
                <p className="font-bold text-base">신한은�?110-412-245177</p>
                <p className="text-yellow-700 text-xs mt-0.5">예금�? 강현�?/p>
              </div>
              <p className="mt-2 text-xs text-yellow-700">
                �?입금기한: 예약 �?<strong>24시간 이내</strong> (미입�?�?자동 취소)
              </p>
        ...
        {isOnsite && (
          <div className="card border-green-200 bg-green-50">
            ...
            <p className="text-sm text-green-800">
              당일 출발 �?현장에서 결제�?주세�? 출발 <strong>30�?�?/strong>까지 도착 부탁드립니�?
            </p>
          </div>
        )}
