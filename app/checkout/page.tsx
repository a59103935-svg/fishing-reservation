...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    function onPopState() { router.push('/') }
    ...
    <div className="max-w-lg mx-auto min-h-screen bg-gray-50 pb-32">
      <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div className="flex items-center px-4 py-4 gap-3">
          <button onClick={() => router.push('/')} className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors">←</button>
